...
export default function Sidebar({ docs }) {
  ...
  useEffect(() => {
    ...
    // সেটিংস অবস্থা আপডেট করার আগে চেক করা:
    if (roots.length > 0) {
      setRootNodes([...roots]);
    } else {
      setRootNodes([]); // roots না থাকলে একটি খালি অ্যারে সেট করা
    }

    if (Object.keys(nonRoots).length > 0) {
      setNonRootNodesGrouped({ ...nonRoots });
    } else {
      setNonRootNodesGrouped({}); // নন-রুট না থাকলে একটি ফাঁকা অবজেক্ট সেট করা
    }
  }, [pathName, docs]); // dependency অ্যারেতে "docs" যোগ করা
